...
```
```{r}
SelectorTypeComparisonPlotFuncConfidenceBands(Naive = NaiveOutputVector$ErrorVec,
                                              Rashomon10 = Rashmon10OutputVector$ErrorVec) -> Plot10_Two

SelectorTypeComparisonPlotFuncConfidenceBands(Naive = NaiveOutputVector$ErrorVec,
                                              Rashomon25 = Rashmon25OutputVector$ErrorVec) -> Plot25_Two

SelectorTypeComparisonPlotFuncConfidenceBands(Naive = NaiveOutputVector$ErrorVec,
                                              Rashomon100 = Rashmon100OutputVector$ErrorVec) -> Plot100_Two
```

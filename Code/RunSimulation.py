...
#chat gpt
import os
# … after you compute SaveDirectory and outpath …
print("DEBUG: cwd       =", os.getcwd())
print("DEBUG: SaveDir   =", SaveDirectory)
print("DEBUG: RawDir    =", os.path.join(SaveDirectory, args.Data, args.ModelType.replace("Function",""), "Raw"))
